...
const Login = () => {
  ...
  return (
    <Container 
      maxWidth="sm" 
      sx={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: mode === "dark" ? "#121212" : "#f5f5f5" }}
    >
      <Card 
        sx={{ 
          p: 4, 
    ...
    sx={{ 
        "& .MuiOutlinedInput-root": {
            ...
            "& fieldset": {
                borderColor: 'transparent', // Ensure fieldset is transparent
            },
            "&:hover fieldset": {
